...
## Enemy balance: the enemy roster plus all difficulty-scaling parameters.
...
# ─── Enemy table ──────────────────────────────────────────────────────────────
## To add a new enemy: create enemies/enemy_xxx.gd with get_data() and add a line here.
static func get_enemy_table() -> Array:
	var spider   = preload("res://scripts/core/game_balance/enemies/enemy_spider.gd")
	var goblin   = preload("res://scripts/core/game_balance/enemies/enemy_goblin.gd")
	var skeleton = preload("res://scripts/core/game_balance/enemies/enemy_skeleton.gd")
	var troll    = preload("res://scripts/core/game_balance/enemies/enemy_troll.gd")
	return [
		spider.get_data(),
		goblin.get_data(),
		skeleton.get_data(),
